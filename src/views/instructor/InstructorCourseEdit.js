...
function InstructorNewCourse(params) {
  ...
  const [videoPreview, setVideoprivie] = useState(false);
  ...
  const handlerequreAddClick = () => {
    setRequrementiInputList([...requrementiInputList, { requirements: " " }]);
  };
  ...
  const GetSectionData = async () => {
    await axios
      .get(`${BaseUrl}forentend/section/all/${editid.id}`, {
        method: "GET",
        headers: {
          "Access-Control-Allow-Origin": "*",
          "Access-Control-Allow-Methods": "GET,PUT,POST,DELETE",
  ...
  const RecieveLessondata = async () => {
    await axios
      .get(`${BaseUrl}forentend/mylesson/${editid.id}`, {
        method: "GET",
        headers: {
          "Access-Control-Allow-Origin": "*",
          "Access-Control-Allow-Methods": "GET,PUT,POST,DELETE",
  ...
  const GetCourseData = async () => {
    await axios
      .get(`${BaseUrl}forentend/onecourse/${editid.id}`, {
        method: "GET",
        headers: {
          "Access-Control-Allow-Origin": "*",
          "Access-Control-Allow-Methods": "GET,PUT,POST,DELETE",
      ...
      .then(function (response) {
        SetCourseAdd(response.data.data[0]);
  ...
  const onSubmit = async (data) => {
    CorurseAdd.requirements = JSON.stringify(requrementiInputList);
    CorurseAdd.outcomes = JSON.stringify(outcomeInputList);
    ...
    const coursedata = {
      requirements: RequiremenyArray,
      outcomes: OutComesArray,
      meta_keywords: CorurseAdd.meta_keywords,
      meta_description: CorurseAdd.meta_description,

      title: CorurseAdd.title,
      description: CorurseAdd.description,
      id_category: CorurseAdd.id_category,
      id_duration: CorurseAdd.id_duration,

      id_features: CorurseAdd.id_features,
      id_language: CorurseAdd.id_language,

      id_level: CorurseAdd.id_level,
      id_price: CorurseAdd.id_price,
      price: CorurseAdd.price,
      id_subtitles: CorurseAdd.id_subtitles,
      id_topic: CorurseAdd.id_topic,
      video_url: video,
      course_img: imges,
    };
    const {
    ...
    if (course_img) {
      ...
      Formdata.append("old_img", CorurseAdd.thumbnail);
    } else {
      Formdata.append("course_img", CorurseAdd.thumbnail);
    }
    ...
    if (video_url) {
      ...
      Formdata.append("old_video", CorurseAdd.video_url);
    } else {
      Formdata.append("video_url", CorurseAdd.video_url);
    }

    await axios
      .put(`${BaseUrl}forentend/updatecourse/${editid.id}`, Formdata, {
        headers: {
          auth: localStorage.getItem("LMS_Token"),
        },
      })
  ...
  const addSection = async () => {
    ...
    if (SectionTitle.title === "" || reWhiteSpace.test(SectionTitle.title)) {
  ...
  const SecndActivationRequest = async () => {
    await axios
      .get(`${BaseUrl}forentend/sendactivation/${editid.id}`, {
        method: "GET",
        headers: {
          "Access-Control-Allow-Origin": "*",
          "Access-Control-Allow-Methods": "GET,PUT,POST,DELETE",
    ...
    <div class="sa4d25">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <h2 class="st_title">
              <i class="uil uil-analysis"></i> Edit Course
            </h2>
          </div>
        </div>
        <div class="row">
                        ...
                        <div class="course__form">
                                ...
                                <div class="ui search focus mt-30 lbel25">
                                  ...
                                  <div class="ui left icon input swdh19">
                                    <input
                                      class="prompt srch_explore"
                                      type="text"
                                      value={CorurseAdd.short_description}
                                    ...
                                    <div class="badge_num2">
                                      {CorurseAdd.short_description
                                        ? 120 -
                                          CorurseAdd.short_description.length
                                        : 120}
                                    </div>
                                  </div>
                                  <br></br>
                          ...
                          <div class="price_course">
                            <div class="row">
                              ...
                              {Amount == true || CorurseAdd.id_price == "2" ? (
                                <>
                              ...
                              <label>Requirements*</label>
                             {
                               fields.map((cv,i)=>{
                                 return(
                                   <>
                                  <div class="ui left icon input swdh19">
                                  <input class="prompt srch_explore mb-2" type="text" placeholder="Insert your course title." name={`user[${i}].requrement`} data-purpose="edit-course-title" maxlength="60" id="main[title]"   ref={register({
                                  required:{
                                    value:true,
                  ...
                  {formStep >= 2 && (
                    ...
                    >
                      <div class="tab-from-content">
                        <div class="title-icon">
                          <h3 class="title">
                            <i class="uil uil-image-upload"></i>View
                          </h3>
                        </div>
                        <div class="course__form">
                                  ...
                                  <div class="view_img_right">
                                    ...
                                    <div class="upload__input">
                                      ...
                                      <div className="ml-1 mt-4">
                                        {videoPreview ? (
                                          <a
                                            href={CorurseAdd.video_url}
                                            target="_blank"
                                          >
                                            {CorurseAdd.video_url.slice(57)}
                                          </a>
                                        ) : (
                                          ""
                                        )}
                                    ...
                                    <div class="course_des_textarea mt-30 lbel25">
                                      ...
                                      <div class="course_des_bg">
                                        <CKEditor
                                          ...
                                          data={LessonDetail.description}
                                          style={{
                                            minHheight: "400px!important",
                                          }}
                                          onReady={(editor) => {
                                            // You can store the "editor" and use when it is needed.
                                          }}
