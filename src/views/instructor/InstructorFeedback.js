...
import instructorFeedbackvalidation from "./instructorFeedbackvalidation";
import {
  CModalFooter,
  CTooltip,
  CButton,
...
// instructor feedback component for feedback page
            ...
            <div className="col-lg-12">
              ...
              <div className="row">
                <div className="col-lg-6 col-md-8">
                  ...
                  {/* {imageError.email && (
                    <p className="text-danger">{imageError.email}</p>
                  )} */}
