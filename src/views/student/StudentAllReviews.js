...
import img1 from "../../images/left-imgs/img-1.jpg";

function StudentAllReviews(params) {
  return (
                ...
                <div className="col-lg-7">
                  ...
                  <div className="review_all120">
                    <div className="review_item_course_title">
                      <Link to="#">Course Title Here</Link>
                    </div>
                    <div className="review_item">
                      ...
                      <p className="rvds10">
                        ...
                        torquent per conubia nostra, per inceptos himenaeos eros
                        ac, sagittis orci."
                      </p>
                    </div>
                  </div>
...
export default StudentAllReviews;
