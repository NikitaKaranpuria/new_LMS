                ...
                <ul class="billing-percentages-progress-bar__labels">
                  <li>
                    <div class="billing-percentages-progress-bar__label billing-percentages-progress-bar__label_zero-level">
                      ...
                      <span class="billing-percentages-progress-bar__percent t5">
                        50%
                      </span>
                    </div>
                  </li>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="basic_ptitle">
              ...
              <p>
                Sell more of your non-exclusive products of this type (equal to
                the amount on the left) to get 70% cut from every non-exclusive
                sales.
              </p>
            </div>
            <div class="billing-percentages">
                ...
                <li>
                  <div class="radio-item_1">
                    <CInput
                      ...
                      data-minimum="50.0"
                    />
                    <label for="paypal1" class="radio-label_1">
                      Paypal
                    </label>
                  </div>
                </li>
                <li>
                  <div class="radio-item_1">
                    <CInput
                      ...
                      data-minimum="50.0"
                    />
                    <label for="payoneer1" class="radio-label_1">
                      Payoneer
                    </label>
                  </div>
                </li>
                <li>
                  <div class="radio-item_1">
                    <CInput
                      ...
                      data-minimum="500.0"
                    />
                    <label for="swift1" class="radio-label_1">
                      Swift
                    </label>
                  </div>
                </li>
                ...
                <div class="col-lg-12">
                  <div class="pymnt_title">
                    ...
                    <p>
                      ...
                      <Link to="#">More about PayPal</Link> |{" "}
                ...
                <div class="col-lg-12">
                  <div class="pymnt_title">
                    ...
                    <p>
                      ...
                      way to get paid. <Link to="#">More about Payoneer </Link>{" "}
                      | <Link to="#">Payoneer FAQs</Link>
                    </p>
                  </div>
                </div>
                <div class="col-lg-4 col-md-4">
                ...
                <div class="col-lg-12">
                  <div class="pymnt_title">
                    ...
                    <p>
                      ...
                      than 200 countries <Link to="#">More about SWIFT</Link>
                    </p>
                  </div>
                </div>
                <div class="col-lg-4 col-md-4">
